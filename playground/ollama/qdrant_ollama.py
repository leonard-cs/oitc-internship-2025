...
from playground.config import NOMIC_VECTOR_SIZE, QDRANT_PORT

COLLECTION_NAME = "Playground-Ollama"
PORT = QDRANT_PORT
VECTOR_SIZE = NOMIC_VECTOR_SIZE

qdrant = QdrantClient(host="localhost", port=PORT)
