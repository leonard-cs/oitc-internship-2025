...
def extract_semantic_query(
    user_query: str = "The weather today is really nice. How are you? What is the most profitable product in our company?",
) -> SemanticQuery:
    ...
    chain = (
        {"user_query": RunnablePassthrough()} | prompt | structured_ollama
        # | {
